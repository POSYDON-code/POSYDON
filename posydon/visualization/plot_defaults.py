...
DEFAULT_LABELS = {
    ...
    'z_formation': [r'$z_\mathrm{formation}$', None],
    'z_merger': [r'$z_\mathrm{merger}$', None],
    ...
    'S2_L_GRB_iso': [r'$L^\mathrm{iso}_\mathrm{GRB}\,[\mathrm{erg}\,\mathrm{s}^{-1}]$',
                r'$\log_{10}(L^\mathrm{iso}_\mathrm{GRB}/\mathrm{erg}\,\mathrm{s}^{-1})$'],
    'S1_f_beaming': [r'$f_\mathrm{beaming}$', None],
    'S2_f_beaming': [r'$f_\mathrm{beaming}$', None],
    'S1_eta' : [r'$\eta$', None],
    'S2_eta' : [r'$\eta$', None],
}
