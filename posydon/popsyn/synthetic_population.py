...
class ParsedPopulation():
    ...
    def create_ccSN_population(self, output_file=None, additional_oneline_cols=None):
        ...
        'time',
        'SN_type' (ECSN/CCSN),
        'observed_SN_type' (Type II, IIb, Ib, Ic)
        'initial_mass' of the progenitor
        'companion_mass' at the moment of SN
        for each 'CC1' and 'CC2',

        Parameters
        -----------
        oneline_cols : list of str
            List of columns to extract from the oneline dataframe and add to
            the SN population dataframe.

        Returns
        --------
        SN_synthetic_population : SyntheticPopulation
            A synthetic population containing SNe with the time of formation
            and merger.
        '''
