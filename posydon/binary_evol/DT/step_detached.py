...
from posydon.binary_evol.DT.magnetic_braking import calculate_magnetic_braking
...
def diffeq(
    ...
    if do_magnetic_braking:
        ...
        p_pri = M_pri, R_pri, Omega_pri, I_pri, tau_conv_pri, Mdot_pri
        p_sec = M_sec, R_sec, Omega_sec, I_sec, tau_conv_sec, Mdot_sec

        dOmega_mb_sec, dOmega_mb_pri =
                calculate_magnetic_braking(p_pri, p_sec, magnetic_braking_mode)
